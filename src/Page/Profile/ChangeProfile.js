                ...
                <form onSubmit={e => Send(e)}>
                    <div>
                        ...
                        <div className='w-full mt-4'>
                            ...
                            <textarea defaultValue={data.info} className='w-[100%] border  rounded-md md:min-h-[10vw] min-h-[30vw] p-2 md:text-[1.2vw] text-[3.5vw]' placeholder='TITU talyp. Voleyboll oynamany halayaryn!' />
                        </div>
